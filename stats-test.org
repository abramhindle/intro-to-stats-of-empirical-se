...
*** T-Test in R
       - in R:
         ...
         t = -1.1333, df = 9.1282, p-value = 0.286
         alternative hypothesis: true difference in means is not equal to 0
         95 percent confidence interval:
          -1.2942206  0.4290484
         sample estimates:
           mean of x   mean of y 
         -0.49281084 -0.06022472 


                 Welch Two Sample t-test

         data:  runif(100) and rnorm(100)
         t = 5.509, df = 118.53, p-value = 2.132e-07
         alternative hypothesis: true difference in means is not equal to 0
         95 percent confidence interval:
          0.3337375 0.7082838
         sample estimates:
         ...
         t = 8.5901, df = 188.9, p-value = 3.213e-15
         alternative hypothesis: true difference in means is not equal to 0
         95 percent confidence interval:
          0.9000211 1.4365920
         sample estimates:
           mean of x   mean of y 
          1.14613689 -0.02216966 
...
*** R code
  ...
  : -0.3833 -0.2246 -0.1500 -0.1664 -0.1006  0.0144 
  :        2.5%       97.5% 
  : -0.35476243 -0.01557738 
...
: [1] 0.3777451
:    Min. 1st Qu.  Median    Mean 3rd Qu.    Max. 
: -0.4822  0.1628  0.3932  0.3777  0.5942  1.0525 
:       2.5%      97.5% 
: -0.2830958  0.9888581 
